...
{// {プレイ人数, 位置, 改行数, 余白, エサの大きさ(幅), エサの大きさ(高さ)}
	...
	{1,D3DXVECTOR3(975.0f,291.0f,0.0f), 4, D3DXVECTOR2(10.0f, 0.0f), 25.0f, 25.0f},	// 1人プレイ時：1P設定情報

	{2,D3DXVECTOR3(65.0f,18.0f,0.0f), 7, D3DXVECTOR2(10.0f, 0.0f), 25.0f, 30.0f},	// 2人プレイ時：1P設定情報	
	{2,D3DXVECTOR3(815.0f,18.0f,0.0f), 7, D3DXVECTOR2(10.0f, 0.0f), 25.0f, 30.0f},	// 2人プレイ時：2P設定情報	
};
