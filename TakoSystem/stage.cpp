//=============================================================================
// 
// モデル [stage.cpp]   ! ! このcppは呼び出さないでください ! !
// Author : 中澤優奈
// 
//=============================================================================
#include "stage.h"
...
// マクロ定義
//*****************************************************************************
#define XSTAGE_FILE				"data\\MODEL\\StageReplica000.x"	// モデルのファイル名
...
D3DXVECTOR3 g_VtxMaxStage, g_VtxMinStage;				// モデルの最大値・最小値
D3DXVECTOR3 g_posStage;									// モデルの位置情報
D3DXVECTOR3 g_moveStage;								// モデルの移動慣性情報
D3DXVECTOR3 g_rotStage;									// モデルの向き情報
